package Day_35_TimeClass._05_periodAndDuration.duration;
...
public class DeterminingDuration {
    public static void main(String[] args) {
        ...
        Duration threeHundredSeconds = Duration.ofSeconds(300);
        System.out.println(now.plus(threeHundredSeconds));
