package Day_38_ExceptionPractise.task3;
...
public class Task3Tests {
    ...
    public void test1(){
        ...
        boolean result = Task3.addPriceToList(string, list);
    ...
    public void test5(){
        ...
        Task3.addPriceToList(string, list);
    }
    ...
    public void test7() throws Exception {
        ArrayList<Double> list = new ArrayList<>();
        Task3.getAverage(list);
    }
    @Test()
    public void test8() throws Exception {
        ArrayList<Double> list = new ArrayList<>(Arrays.asList(1.0));
        Double average = Task3.getAverage(list);
